...
public class PredictiveLookAt2D : MonoBehaviour 
{
	...
	protected virtual void Update () 
	{
		...
		var vel = (target.position - lastPosition) / Time.deltaTime;
		targetVelocity = Vector3.Lerp( targetVelocity, vel, 0.1f );//target.velocity;
